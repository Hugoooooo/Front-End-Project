...
var percDiv = document.getElementById('percent');  
 var mb_percent=$(".list-cardeo .icon-Y").length*0.25;
$(function() {
	$('#progress').circliful();         
});

//pc
function PC_run(percent) {     
    var endpoint = percent*360;
    Snap.animate(0, endpoint,   function (val) {   
           percDiv_pc.innerHTML = Math.round(val/360*100) +'%';
    }, percent*4500, mina.easeinout);  
} 
...
(function ($) {
    $.fn.circliful = function (options, callback) {
        ...
        return this.each(function () {
            ...
            PC_run(percent); //for percent text  
            ...
            percDiv_pc = document.getElementById('pc_percnet')
...
// LINE ANIMATE PROGRESS BAR FILL
